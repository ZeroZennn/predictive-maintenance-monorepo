    ...
    <section className="relative w-full min-h-screen flex items-center pl-6 md:pl-16 lg:pl-24 xl:pl-32 pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          className="absolute top-0 right-0 w-full lg:w-2/3 h-full object-cover opacity-40 mix-blend-luminosity"
        />
        {/* Gradient to fade the left side into the dark background */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#081819] via-[#081819]/80 via-40% to-transparent" />
