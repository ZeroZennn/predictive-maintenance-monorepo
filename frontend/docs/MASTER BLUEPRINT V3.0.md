...
3. **Anomaly & Alert:** Pipeline ML mendeteksi anomali pada M-01. Backend menembakkan *WebSocket broadcast*. Sistem memunculkan **Global Toast Alert** di layar teknisi: *"⚠️ M-01 memasuki fase Warning"*, dan kartu M-01 di sidebar berubah kuning.  
